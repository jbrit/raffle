...
from .views import home_view, signup_view, SettingsView, EditProfileView, change_password, get_winner, activate, account_activation_sent, login_view, LogoutView
...
urlpatterns = [
    ...
    path('get_winner/', get_winner, name="get_winner"),
